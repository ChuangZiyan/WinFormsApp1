...
Public Class MyWebDriver
    ...
    Public Function Upload_Product_Detail_Profile(content, jsonData)
        ...
        Try
            ...
            Thread.Sleep(2000)
            'located_input.SendKeys(Keys.Enter)
            chromeDriver.FindElement(By.CssSelector("div.x1jx94hy.x1lq5wgf.xgqcy7u.x30kzoy.x9jhf4c.xbsqzb3.x9f619.x78zum5.xdt5ytf.x1iyjqo2.xr9ek0c.xh8yej3 > div > ul > li:nth-child(1)")).Click()
